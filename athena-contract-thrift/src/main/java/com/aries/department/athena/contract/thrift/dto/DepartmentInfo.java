...
public class DepartmentInfo implements org.apache.thrift.TBase<DepartmentInfo, DepartmentInfo._Fields>, java.io.Serializable, Cloneable, Comparable<DepartmentInfo> {
    ...
    private static final org.apache.thrift.protocol.TField UP_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("upId", org.apache.thrift.protocol.TType.I64, (short) 4);
    ...
    java.lang.String departmentName; // required
    ...
    public DepartmentInfo setDepartmentName(@org.apache.thrift.annotation.Nullable java.lang.String departmentName) {
        this.departmentName = departmentName;
        return this;
    }
    ...
    public DepartmentInfo setLeaderId(long leaderId) {
        this.leaderId = leaderId;
        setLeaderIdIsSet(true);
        return this;
    }
    ...
    public DepartmentInfo setUpId(long upId) {
        this.upId = upId;
        setUpIdIsSet(true);
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(upId);
    ...
    public int compareTo(DepartmentInfo other) {
        ...
        lastComparison = java.lang.Boolean.valueOf(isSetUpId()).compareTo(other.isSetUpId());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetUpId()) {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder sb = new java.lang.StringBuilder("DepartmentInfo(");
        boolean first = true;
